...
add_action('widgets_init', 'footer_widget_four');

add_action('widgets_init', 'footer_widget_three');

function footer_widget_five()
{

    register_sidebar(array(
        'name' => 'Footer Widget Five',
        'id' => 'footer_widget_5',
        'before_widget' => '<div>',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="rounded">',
...
add_action('widgets_init', 'footer_widget_five');
